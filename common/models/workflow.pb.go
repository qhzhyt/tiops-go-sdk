...
type WorkflowInfo struct {
	...
	Extra                map[string]string `protobuf:"bytes,12,rep,name=extra,proto3" json:"extra,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" bson:"extra"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-" bson:"-"`
	XXX_unrecognized     []byte            `json:"-" bson:"-"`
	XXX_sizecache        int32             `json:"-" bson:"-"`
}
...
func (m *WorkflowInfo) GetExtra() map[string]string {
	if m != nil {
		return m.Extra
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "models.WorkflowInfo.ExtraEntry")
}
...
var fileDescriptor_4f48be07aba71763 = []byte{
	...
	,
}
