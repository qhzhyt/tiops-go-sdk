...
type ActionRequest struct {
	...
	TraceId int32 `protobuf:"varint,5,opt,name=traceId,proto3" json:"traceId,omitempty" bson:"traceId"`
}
...
func (x *ActionRequest) GetTraceId() int32 {
	if x != nil {
		return x.TraceId
	}
	return 0
...
type ActionResponse struct {
	...
	TraceId int32                  `protobuf:"varint,7,opt,name=traceId,proto3" json:"traceId,omitempty" bson:"traceId"`
}
...
func (x *ActionResponse) GetTraceId() int32 {
	if x != nil {
		return x.TraceId
	}
	return 0
...
var file_tiops_common_services_action_proto_rawDesc = []byte{
	...
	0x61, 0x63, 0x65, 0x49, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x74, 0x72, 0x61,
	...
	0x63, 0x65, 0x49, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x74, 0x72, 0x61, 0x63,
	...
	0x0c, 0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x2a, 0x2c, 0x0a, 0x08, 0x44, 0x61, 0x74, 0x61, 0x54,
	...
	0x09, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x43, 0x6d, 0x64, 0x10, 0x01, 0x32, 0xc5, 0x03, 0x0a,
	...
	0x69, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x00, 0x12, 0x41, 0x0a, 0x0e, 0x43,
	0x61, 0x6c, 0x6c, 0x48, 0x74, 0x74, 0x70, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x15, 0x2e,
	...
	0x48, 0x74, 0x74, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x44,
	0x0a, 0x0b, 0x50, 0x75, 0x73, 0x68, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x17, 0x2e,
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x4d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x18, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x73, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x22, 0x00, 0x28, 0x01, 0x42, 0x1a, 0x0a, 0x18, 0x69, 0x6f, 0x2e, 0x74, 0x69, 0x6f, 0x70, 0x73,
	0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73,
...
var file_tiops_common_services_action_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_tiops_common_services_action_proto_goTypes = []interface{}{
	...
	nil,                               // 18: services.ActionRequest.InputsEntry
	nil,                               // 19: services.ActionResponse.OutputsEntry
	nil,                               // 20: services.RegisterActionNodeRequest.ActionOptionsEntry
	nil,                               // 21: services.ActionMessage.HeaderEntry
	nil,                               // 22: services.ActionStatus.ExtraEntry
	nil,                               // 23: services.ServiceStatus.ActionsStatusEntry
	nil,                               // 24: services.HttpRequest.PostFormEntry
	nil,                               // 25: services.HttpRequest.GetArgsEntry
	(*models.WorkflowInfo)(nil),       // 26: models.WorkflowInfo
...
var file_tiops_common_services_action_proto_depIdxs = []int32{
	...
	18, // 1: services.ActionRequest.inputs:type_name -> services.ActionRequest.InputsEntry
	1,  // 2: services.ActionResponse.code:type_name -> services.ResponseCode
	19, // 3: services.ActionResponse.outputs:type_name -> services.ActionResponse.OutputsEntry
	7,  // 4: services.NextActions.actions:type_name -> services.ServiceAndAction
	20, // 5: services.RegisterActionNodeRequest.actionOptions:type_name -> services.RegisterActionNodeRequest.ActionOptionsEntry
	...
	21, // 8: services.ActionMessage.header:type_name -> services.ActionMessage.HeaderEntry
	22, // 9: services.ActionStatus.extra:type_name -> services.ActionStatus.ExtraEntry
	23, // 10: services.ServiceStatus.actionsStatus:type_name -> services.ServiceStatus.ActionsStatusEntry
	...
	24, // 13: services.HttpRequest.postForm:type_name -> services.HttpRequest.PostFormEntry
	25, // 14: services.HttpRequest.getArgs:type_name -> services.HttpRequest.GetArgsEntry
	...
	26, // 21: services.ActionsService.GetRequiredResources:input_type -> models.WorkflowInfo
	...
	27, // 26: services.ActionsService.RegisterActionNode:output_type -> services.StatusResponse
	28, // 27: services.ActionsService.GetRequiredResources:output_type -> models.WorkflowResources
	...
	27, // 30: services.ActionsService.PushMessage:output_type -> services.StatusResponse
